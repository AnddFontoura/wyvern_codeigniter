...
<div class="row">
  ...
  <div class='col-md-12 col-lg-12 col-sm-12 text-right mb-3'>
    <a class='btn btn-primary' href='<?php echo site_url('admin/item/create'); ?>'> Novo Item </a>
  </div>
    		...
    		<div class="card-body" style="">
    			<div class='row'>
    				<div class="form-group col-md-3">
    					<label for="itemName">Id do Item:</label>
    				...
    				<div class="form-group col-md-3">
    					<label for="itemName">Classificação do Item</label>
    					<?php echo $search_classificationitem; ?>
    				</div>

    				<div class="form-group col-md-3">
    					<label for="itemName">Status do Item</label>
              ...
              <div class="card-body">
                <div class='row'>
                  ...
                  <div class='col-md-6 col-lg-6 col-sm-12'>
                    ...
                    <h5 class="card-title">{{ $dado_tabela['item_name'] }}</h5>
                  </div>

                  <div class='col-md-6 col-lg-6 col-sm-12'>
                    <p class="card-text"><small class="text-muted">Status:</small></p>
                    <h5 class="card-title @if($dado_tabela['item_status'] == 1) badge badge-success @else badge badge-danger @endif">@if($dado_tabela['item_status'] ==1) Ativo @else Inativo @endif  </h5>
                  </div>

                  <div class='col-md-12 col-lg-12 col-sm-12'>
                    <p class="card-text"><small class="text-muted">Descrição:</small></p>
                    <p class="card-text">{!! $dado_tabela['item_description'] !!}</p>
                  </div>
                </div>
              </div>
              <div class="card-footer text-right">
                <div class='btn-group'>
                  <a class='btn btn-primary' href="{{ base_url('admin/item/edit/'.$dado_tabela['id_item']) }}"> Editar </a>
                  <button class="btn @if($dado_tabela['item_status'] == 0) btn-success @else btn-danger @endif" data-id="{{ $dado_tabela['id_item'] }}" id="changeStatus"> @if($dado_tabela['item_status'] == 0) Ativar @else Inativar @endif </button>
                </div>
              </div>
            </div>
          </div>
